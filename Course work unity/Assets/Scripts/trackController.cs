...
public class trackController : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        roadCurPoint.x = 1;
        roadCurPoint.y = 0;
        rSeed = System.DateTime.Now.Millisecond * 
            ...
            if(Random.value < 0.5f)
            {
                ...
                switch(_curRotMode)
                {
                    ...
                    case 0:
                        ...
                        {
                            Instantiate(stopSigns[Random.Range(0, stopSigns.Length)], new Vector3(curTrackCluster.transform.position.x, 0, curTrackCluster.transform.position.z + 1), Quaternion.Euler(0, 180, 0), curTrackCluster.transform);
                            break;
                        }
                        if(Random.value > 0.3f)
                        {
                            Instantiate(stopSigns[Random.Range(0, stopSigns.Length)], new Vector3(curTrackCluster.transform.position.x + 1, 0, curTrackCluster.transform.position.z), Quaternion.Euler(0, -90, 0), curTrackCluster.transform);
                        }
                    break;
                    case 1:
